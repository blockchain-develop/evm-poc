...
async function main() {
    ...
    const alertBotContract = await ethers.deployContract("AlertBot", [cryptoVaultAddr])
    const alertBotAddr = await alertBotContract.getAddress()
    console.log("alert bot address = ", alertBotAddr)
    ...
    fortaContract.setDetectionBot(alertBotAddr)
